...
const SectionClienteGrupo = ({ data, handleChange, isBlocked, isMainBlocked, isUpdate, addIntegrante, removeIntegrante, updateMontoIntegrante }) => (
                    ...
                    <table className="w-full text-left text-sm">
                        ...
                        <tbody className="divide-y divide-slate-50">
                            ...
                            {data.integrantes.length === 0 && (
                                <tr><td colSpan="3" className="px-4 py-8 text-center text-slate-400 text-xs italic">Busca y selecciona clientes para armar el grupo.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
