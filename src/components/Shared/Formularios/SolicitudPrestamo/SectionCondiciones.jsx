...
const SectionCondiciones = ({ data, handleChange, isBlocked }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden">
            ...
            {/*
             * ── Calculadora ─────────────────────────────────────────────────
             * En modo grupal pasamos los integrantes con sus tasas individuales
             * para que la calculadora muestre el desglose por cada uno.
             * En modo individual usamos los props legacy.
             */}
