                        ...
                        <>
                            <div>
                                ...
                                <input type="text" value={data.dni || ''} onChange={(e) => onChange('dni', onlyNumbers(e.target.value, 8))}
                                    ...
                                    required readOnly={!isEditing && !!data.dni} />
                            </div>
                            <div>
                                ...
                                <input type="date" value={data.fechaVencimientoDni || ''} onChange={(e) => onChange('fechaVencimientoDni', e.target.value)}
                                    className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-red-500 outline-none" required />
                            </div>
                        ...
                        <>
                            <div className="sm:col-span-2">
                                ...
                                <input type="text" value={data.ruc || ''} onChange={(e) => onChange('ruc', onlyNumbers(e.target.value, 11))}
                                    className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-yellow-500 outline-none"
                                    required readOnly={!isEditing && !!data.ruc} />
                            </div>
                            <div className="sm:col-span-2">
                                ...
                                <input type="text" value={data.razon_social || ''} onChange={(e) => onChange('razon_social', toUpper(e.target.value))}
                                    className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-yellow-500 outline-none" required />
                            </div>
                            <div className="sm:col-span-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" value={data.telefono || ''} onChange={(e) => onChange('telefono', onlyNumbers(e.target.value, 9))}
                            className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" required />
                    </div>
                    <div>
                        ...
                        <input type="text" value={data.telefonoFijo || ''} onChange={(e) => onChange('telefonoFijo', onlyNumbers(e.target.value, 15))}
                            className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" />
                    </div>
                    <div className="sm:col-span-2">
                    ...
                    <div className="sm:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-2">
                        ...
                        <div>
                            ...
                            <select value={data.provincia || ''} onChange={(e) => onChange('provincia', e.target.value)}
                                ...
                                className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none disabled:bg-slate-100 disabled:text-slate-400" required>
                                <option value="">-- Seleccionar --</option>
                                {provincias.map((prov) => (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" value={data.ingreso_estimado || ''} onChange={(e) => onChange('ingreso_estimado', onlyNumbers(e.target.value))}
                            className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none font-bold text-green-700"
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <input type="text" value={data.proposito || ''} onChange={(e) => onChange('proposito', toUpper(e.target.value))}
                            className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none"
                            placeholder="EJ: CAPITAL DE TRABAJO, COMPRA DE MERCADERÍA..." required />
                    </div>
                    <div className="sm:col-span-2 mt-2">
                        <label className="block text-[11px] font-bold text-slate-500 uppercase mb-1">
                        ...
                        <textarea value={data.observaciones || ''} onChange={(e) => onChange('observaciones', toUpper(e.target.value))}
                            className="w-full p-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none min-h-[80px]"
