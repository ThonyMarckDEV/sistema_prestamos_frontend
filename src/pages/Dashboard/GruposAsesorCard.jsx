                ...
                <>
                    ...
                    <div className="px-6 py-2 border-b border-slate-50 bg-white">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100">
                            ...
                            <span className="text-[10px] font-black text-slate-700">{rango.desde ?? fechaInicio}</span>
                            <span className="text-slate-400 text-[10px]">→</span>
                            <span className="text-[10px] font-black text-slate-700">{rango.hasta ?? fechaFin}</span>
                        </div>
                    </div>
