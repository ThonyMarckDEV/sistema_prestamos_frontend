                                    ...
                                    <tr key={f.asesor_id} className={`hover:bg-slate-50 transition-colors ${i % 2 === 0 ? '' : 'bg-slate-50/30'}`}>
                                        <td className="px-4 py-3">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-xs font-black text-slate-700 uppercase truncate max-w-[160px]">{f.nombre}</span>
                                            </div>
                                        </td>
                                        <td className="px-4 py-3 text-right">
                                            <span className="text-sm font-black text-slate-900">S/ {fmt(f.monto)}</span>
                                        </td>
                                        <td className="px-4 py-3 text-right">
                                            <span className="text-sm font-black text-slate-600">{fmtN(f.clientes)}</span>
                                        </td>
                                        <td className="px-4 py-3 text-right">
                                            <span className="text-sm font-black text-slate-600">{fmtN(f.integrantes)}</span>
                                        </td>
                                        <td className="px-4 py-3 text-right">
                                            <span className="text-sm font-black text-slate-600">{fmtN(f.grupos)}</span>
                                        </td>
                                        <td className="px-4 py-3 text-right">
                                            <span className="text-sm font-black text-brand-red">{fmtN(f.total_pers)}</span>
                                        </td>
                                        <td className="px-4 py-3 text-right">
                                            <span className="text-sm font-black text-brand-gold-dark">S/ {fmt(f.ticket)}</span>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
