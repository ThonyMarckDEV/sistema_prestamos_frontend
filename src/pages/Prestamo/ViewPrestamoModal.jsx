...
import { showIntegrante } from 'services/prestamoService';
...
const ViewPrestamoModal = ({ isOpen, onClose, data, isLoading }) => {
    ...
    // Cronograma a mostrar: del integrante si hay uno seleccionado, si no el grupal
        ...
        >
            {data && (
                <div className="space-y-6">
                    ...
                    {/* 2. Desglose de Integrantes (SOLO SI ES GRUPAL) */}
                    ...
                    <div>
                        <h4 className="flex items-center gap-2 text-[11px] font-black text-slate-700 uppercase mb-3 tracking-widest px-1">
                            ...
                            {esVistaIntegrante
                                ? `Cronograma Individual — ${data.integrantes.find(i => i.id === integranteSeleccionado)?.nombre ?? ''}`
                            ...
                            <div className="overflow-hidden border border-slate-200 rounded-2xl shadow-sm">
                                <table className="w-full text-left border-collapse">
                                    ...
                                    <tbody className="divide-y divide-slate-100 bg-white">
                                        {esVistaIntegrante ? (
                                            // Vista individual del integrante
