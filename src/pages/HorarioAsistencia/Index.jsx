...
import { useIndex } from 'hooks/HorarioAsistencia/useIndex';
import Table from 'components/Shared/Tables/Table';
import PageHeader from 'components/Shared/Headers/PageHeader';
import AlertMessage from 'components/Shared/Errors/AlertMessage';
import ConfirmModal from 'components/Shared/Modals/ConfirmModal';
import { ClockIcon, PencilSquareIcon, TrashIcon, CheckCircleIcon, XCircleIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
        ...
        },
        {
            ...
            render: (row) => (
                <div className="flex justify-end gap-2">
                    <Link to={`/horario-asistencia/editar/${row.id}`}
    ...
    return (
        <div className="container mx-auto p-6 transition-colors">
            <PageHeader
                ...
                buttonLink="/horario-asistencia/agregar"
            />
