    ...
    return (
        <div className="container mx-auto p-4 sm:p-6">
            ...
            <Table
                ...
                filterConfig={[{ name: 'search', type: 'text', label: 'Buscar Caja', colSpan: 'col-span-8' }, { name: 'activo', type: 'select', label: 'Estado', colSpan: 'col-span-4', options: [{ value: '', label: 'Todos' }, { value: '1', label: 'Activos' }, { value: '0', label: 'Inactivos' }] }]} 
